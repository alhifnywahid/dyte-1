...
<div className="mid">
  <img
    width="100%"
    src="https://student-activity.binus.ac.id/himti/wp-content/uploads/sites/13/2019/03/Capture-1.png"
    alt="James Gosling"
  />
  <hr />
</div>
...
<div className="mid">
  <img
    width="40%"
    src="https://www.petanikode.com/img/java-untuk-pemula/james-gosling.jpg"
    alt="James Gosling"
  />
  <hr />
</div>
